...
def get_provider_info():
    return {
        ...
        "triggers": [
            ...
            {
                "integration-name": "Google Dataflow",
                "class-names": ["airflow.providers.google.cloud.triggers.dataflow.TemplateJobStartTrigger"],
            },
            {
                "integration-name": "Google Data Fusion",
                "class-names": [
            ...
            {
                "integration-name": "Google Cloud Storage (GCS)",
                "class-names": ["airflow.providers.google.cloud.triggers.gcs.GCSBlobTrigger"],
            },
            {
                "integration-name": "Google Kubernetes Engine",
                "class-names": [
